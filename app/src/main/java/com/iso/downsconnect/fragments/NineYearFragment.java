...
public class NineYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nineyears, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        yes1 = view.findViewById(R.id.checkBoxYes106);
        no1 = view.findViewById(R.id.checkBoxNo107);
        yes2 = view.findViewById(R.id.checkBoxYes107);
        no2 = view.findViewById(R.id.checkBoxNo108);
        yes3 = view.findViewById(R.id.checkBoxYes108);
        no3 = view.findViewById(R.id.checkBoxNo109);
        yes4 = view.findViewById(R.id.checkBoxYes109);
        no4 = view.findViewById(R.id.checkBoxNo110);
        yes5 = view.findViewById(R.id.checkBoxYes110);
        no5 = view.findViewById(R.id.checkBoxNo111);
        yes6 = view.findViewById(R.id.checkBoxYes111);
        no6 = view.findViewById(R.id.checkBoxNo112);
        yes7 = view.findViewById(R.id.checkBoxYes112);
        no7 = view.findViewById(R.id.checkBoxNo113);

        date1 = view.findViewById(R.id.assessDate49);
        date2 = view.findViewById(R.id.assessDate50);
        date3 = view.findViewById(R.id.assessDate51);
        date4 = view.findViewById(R.id.assessDate52);

        provider1 = view.findViewById(R.id.Spin9_1);
        provider2 = view.findViewById(R.id.Spin9_2);
        provider3 = view.findViewById(R.id.Spin9_3);
        provider4 = view.findViewById(R.id.Spin9_4);
